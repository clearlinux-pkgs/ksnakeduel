...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/ksnakeduel-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/ksnakeduel-24.12.0.tar.xz.sig
...
%setup -q -n ksnakeduel-24.12.0
cd %{_builddir}/ksnakeduel-24.12.0
pushd ..
cp -a ksnakeduel-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735179768
mkdir -p clr-build
pushd clr-build
