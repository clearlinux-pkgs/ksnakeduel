...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/ksnakeduel-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/ksnakeduel-22.08.2.tar.xz.sig
...
%prep
%setup -q -n ksnakeduel-22.08.2
cd %{_builddir}/ksnakeduel-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665708500
mkdir -p clr-build
pushd clr-build
